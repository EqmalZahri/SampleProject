...
{
    /// <inheritdoc />
    public partial class ReMigrateDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AgencyGroupings",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgencyGroupings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgencyGroup = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
